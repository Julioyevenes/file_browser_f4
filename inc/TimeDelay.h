...
/****************************************************************************
  Macro:
    void Delay10us( tenMicroSecondCounter )
  ...
  Parameters:
    tenMicroSecondCounter - number of ten microsecond delays
    to perform at once.
  ...
  Remarks:
    None
  ***************************************************************************/
#define Delay10us(tenMicroSecondCounter) Delay(10*tenMicroSecondCounter)
...
/****************************************************************************
  ...
  Parameters:
    ms - number of one millisecond delays to perform at once.
  ...
  Remarks:
    None
  ***************************************************************************/
#define DelayMs(ms) Delay(1000*ms)
