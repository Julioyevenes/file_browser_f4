...
void RTCCProcessEvents(void)
{
    ...
    while(!_rtcc_flag)
    {
        ...
        _time.sec = RTC_TimeStruct.RTC_Seconds;     // SEC
        _time.min = RTC_TimeStruct.RTC_Minutes;     // MIN
        _time.hr = RTC_TimeStruct.RTC_Hours;        // HR
        /* Copy time values again */
        _time_chk.sec = RTC_TimeStruct.RTC_Seconds;     // SEC
        _time_chk.min = RTC_TimeStruct.RTC_Minutes;     // MIN
        _time_chk.hr = RTC_TimeStruct.RTC_Hours;        // HR

        /* Get date values */
        RTC_DateTypeDef RTC_DateStruct;
        RTC_GetDate(RTC_Format_BCD, &RTC_DateStruct);
        _time.wkd = RTC_DateStruct.RTC_WeekDay;     // WDAY
        _time.day = RTC_DateStruct.RTC_Date;        // DAY;
        _time.mth = RTC_DateStruct.RTC_Month;       // MONTH;
        _time.yr = RTC_DateStruct.RTC_Year;         // YEAR
        /* Copy date values again */
        _time_chk.wkd = RTC_DateStruct.RTC_WeekDay;     // WDAY
        _time_chk.day = RTC_DateStruct.RTC_Date;        // DAY;
        _time_chk.mth = RTC_DateStruct.RTC_Month;       // MONTH;
        _time_chk.yr = RTC_DateStruct.RTC_Year;         // YEAR
        #else
...
void RTCCSet(void)
{
    ...
    /* Set time values */
    RTC_TimeTypeDef RTC_TimeStruct;
    RTC_TimeStruct.RTC_Hours = _time_chk.hr;
    RTC_TimeStruct.RTC_Minutes = _time_chk.min;
    RTC_TimeStruct.RTC_Seconds = _time_chk.sec;
    RTC_SetTime(RTC_Format_BCD, &RTC_TimeStruct);

    /* Set date values */
    RTC_DateTypeDef RTC_DateStruct;
    RTC_DateStruct.RTC_WeekDay = _time_chk.wkd;
    RTC_DateStruct.RTC_Month = _time_chk.mth;
    RTC_DateStruct.RTC_Date = _time_chk.day;
    RTC_DateStruct.RTC_Year = _time_chk.yr;
